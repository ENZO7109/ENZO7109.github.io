...
<script language="JavaScript">
 ...
 function ok(){
    window.parent.parent.location.href='https://www.0598128.com';
 }
 window.setTimeout("ok();",100000);
 ...
 function countDown(secs){
  ...
  <!-- ZUI Javascript组件 --> 
       <!--div style='display:none'> <script src="../../js/yanzheng.js"></script> </div-->
